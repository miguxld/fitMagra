    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-10 lg:gap-16 items-center min-h-[calc(100svh-10rem)]">
        ...
        <div className="z-10 flex flex-col justify-center">
          ...
          {/* Mini stats */}
          <div
            className={`mt-12 grid grid-cols-3 gap-6 border-t border-[var(--color-card-border)] pt-7 transition-all duration-700 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            style={{ transitionDelay: "0.9s", transitionTimingFunction: "cubic-bezier(0.16,1,0.3,1)" }}
          >
            {[
        ...
        >
          ...
          <div
            className="absolute bottom-[20%] -right-2 md:-right-5 bg-[var(--color-surface)] border border-[var(--color-card-border)] rounded-[14px] py-3 px-4 shadow-[0_10px_30px_rgba(0,0,0,.25)] animate-float z-10"
